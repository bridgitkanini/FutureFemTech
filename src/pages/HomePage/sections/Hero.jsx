  ...
  return (
    <div>
      <header
        ...
        style={{
          backgroundImage: `linear-gradient(to bottom, rgba(92, 77, 66, 0.6), rgba(92, 77, 66, 0.6)), url(${heroImage})`,
          ...
          <div className="flex justify-center">
            <div className="max-w-2xl">
              ...
              <p className="text-base md:text-xl px-2">
                Empowering the next generation of girls in STEM through
                personalized learning paths that adapt to your passions, pace,
                and progress.
              </p>
              <Link
